...
def optimize_pose(
    ...
    start_pose_index: int = t.Option(10, help="start pose index"),
    end_pose_index: int = t.Option(0, help="end pose index"),
    ...
    def convert_to_pose(x):
        ...
        # q =  w, x, y, z
        rot = transforms3d.euler.euler2mat(euler[0], euler[1], euler[2], "szyz")
        DT = np.eye(4)
        DT[:3, :3] = rot
        DT[:3, 3] = p
        return DT
